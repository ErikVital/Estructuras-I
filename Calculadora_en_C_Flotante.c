...
void preguntaOp();
void capturaNums(float *num1, float *num2);
float suma(float num1, float num2);	
float resta(float num1, float num2);
float multiplica(float num1, float num2);
float divide(float num1, float num2);
float potencia(float num1, float num2);
int modulo(int nume1, int nume2);
float raiz(float num1, float num2);
void raizcuadrada(float res1, float res2, float num1, float num2);
void muestraResultado(float res);
void pregunta();
...
void preguntaOp()
{
	...
	system("cls");
	printf("\nBienvenido!!\nA la Calculadora 2.0 a numeros flotantes \n1.-Suma\n2.-Resta\n3.-Multiplicacion\n4.-Division\n5.-Potencia\n6.-Modulo\n7.-Raiz Cuadrada\n\n");
    scanf("%d",&opcion);
    ...
    case 6:
    	...
    	capturaNums(&num1,&num2);
    	int nume1=(int)num1, nume2=(int)num2, rese;
    	res=modulo(nume1,nume2);
    	rese=(int)res;
    	system("cls");
    	muestraResultado(rese);
    	break;
    case 7:
    	system("cls");
